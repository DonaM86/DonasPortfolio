  ...
  return (
    ...
    >
      ...
      <Paragraph className="hero-paragraph">
        I bring a unique blend of creativity, technical expertise, and a passion
        for solving complex problems. Here's why collaborating with me will be a
        great decision:
      </Paragraph>

      <div className="hero-icons">
        <div className="hero-icon">
          <FaCode size={50} color="#ff6f61" />
        ...
        <div className="hero-icon">
          <FaLightbulb size={50} color="#ff6f61" />
          <Title level={4} className="hero-icon-title">
